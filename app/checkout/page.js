  ...
  return (
    <div className={`space-y-1.5 ${className}`}>
      ...
      <input
        ...
        maxLength={maxLength}
        className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 outline-none placeholder:text-slate-400 focus:border-orange-500"
      />
    </div>
  );
}